...
function Alumni() {
  return (
    <div className="alumni-container">
      {alumniData.map(alumni => (
        <div className="alumni-item-container">
          <img src={Rajiv} className="profile-img"/>
          <div className="alumni-name">{alumni.name}</div>
          <div className="alumni-paper"><i>{alumni.thesis}</i></div>
    ...
    //     <img src={Sheng} className="profile-img" alt="sheng" />
    //     <div className="year">Sheng Yang</div>
    //     <div className="paper">
    ...
    //     <img src={Ioana} className="profile-img" alt="ioana" />
    //     <div className="year">
    ...
    //     <img src={Kanthi} className="profile-img" alt="kanthi" />
    //     <div className="year">
    ...
    //     <img src={Koyel} className="profile-img" alt="koyel" />
    ...
    //     <img src={Saeed} className="profile-img" alt="saeed" />
    ...
    //     <img src={Rajiv} className="profile-img" alt="rajiv" />
    //     <div className="year">
